...
from src.tasks.validators.pushup_validator import PushupState, PushupValidator
from src.tasks.validators.squat_validator import SquatState, SquatValidator
