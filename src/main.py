...
def main():
    ...
    print(f"Starting Fitness Dice Game...")
    ...
    try:
        ...
        config_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "config", "exercises.json")
    ...
    if args.mode == "mock":
        ...
        engine_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "assets", "models", "yolov8n-pose.engine")
